...
/**
 * Figma OAuth Testing Script
 * 
 * Usage:
 * 1. Update your .env.local file with your Figma credentials:
 *    FIGMA_CLIENT_ID=your_client_id_here
 *    FIGMA_CLIENT_SECRET=your_client_secret_here
 * 
 * 2. Run this script: node test-figma.js
 * 
 * 3. Follow authentication flow in your browser
 * 
 * 4. Test different Figma API endpoints
 */
...
console.log('🚀 Figma OAuth Testing Script');
console.log('===============================\n');
...
async function testFigmaConnection() {
  ...
  console.log(`   Open this URL in your browser: ${BASE_URL}/api/oauth/start/figma\n`);
  ...
  console.log('3️⃣ Test different Figma endpoints:');
  console.log('   a) Basic user info test:');
  console.log(`      POST ${BASE_URL}/api/test/figma`);
  ...
  console.log(`   curl -X POST ${BASE_URL}/api/test/figma \\`);
...
async function main() {
  ...
  try {
    ...
    console.log('   2. You have set your Figma credentials in .env.local');
...
module.exports = { testFigmaConnection, runManualTest, checkServer };
